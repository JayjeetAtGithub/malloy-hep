...
SELECT 
   ((floor((CASE WHEN cross_join_sql."pt_sum"<15 THEN 14.9 WHEN cross_join_sql."pt_sum">200 THEN 200.1 ELSE cross_join_sql."pt_sum"-0.2 END)*1.0/1.85))*1.85)+1.125 as "x",
   COUNT( 1) as "y"
FROM (
        SELECT 
            event,
